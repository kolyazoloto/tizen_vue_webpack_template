  ...
  methods: {
    /*applicationControlTest:function(){
      var appControl = new ApplicationControl('http://tizen.org/appcontrol/operation/view',
                                                    'https://shikimori.me/oauth/authorize?client_id=lj2l2B_QDAZfO8YBqHzaw2Ue9BC9-EKvuXpChn-29X4&redirect_uri=urn%3Aietf%3Awg%3Aoauth%3A2.0%3Aoob&response_type=code&scope=user_rates+comments+topics', null, null, null, null);
