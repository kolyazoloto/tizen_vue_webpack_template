...
<template>
  <div tabindex="-1" class="smotretAnimeComponent" :class="{login:islogin}"
  @focus="getFocus"
  >
    ...
    <div v-if="islogin" class="content login">
        ...
        >
          <p class="text">
            Так как сайт не предоставляет информации о пользователе вы видите этот текст.
          </p>
        </div>
...
<style scoped="true" lang="scss" src="./loginSmotretAnimeComponent.scss"></style>
